...
| | `/autoss [minutes]` | Auto‑screenshot interval |
...
Detailed setup instructions are provided **only to paying customers**.  
They cover:

- Configuring your Telegram bot.
- Installing the APK on the target device.
- Granting necessary permissions (Accessibility, Device Admin).
- First‑time usage and testing.
...
| **2.1** | 2026-06-15 | • Lockscreen overlay with PIN and developer number.<br>• Audio/video recording from camera.<br>• Improved callback handling. |
...
*Made with Love for responsible monitoring.*
